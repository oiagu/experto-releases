# Experto — versões para Mac

Aqui ficam as versões publicadas do app do Mac do Experto: o instalador (`.dmg`) e o pacote que o app usa para
se atualizar sozinho (`Experto.app.tar.gz` + assinatura + `latest.json`).
